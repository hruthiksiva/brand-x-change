        ...
        <div className="md:hidden bg-white border-t border-neutral-200">
          <div className="px-4 py-3 space-y-3">
            ...
            <div className="space-y-1">
              <Link
                to="/"
                className="block px-3 py-2 rounded-lg text-sm font-inter text-neutral-600 hover:text-primary hover:bg-neutral-50"
              >
                Home
              </Link>
              <Link
            ...
            <div className="pt-2 space-y-2">
              {currentUser ? (
                <>
                  <Link
                    to="/create-listing"
                    className="flex items-center px-3 py-2 rounded-lg text-sm font-inter bg-primary/10 text-primary hover:bg-primary/20"
                  >
                    <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4v16m8-8H4" />
                    </svg>
                  ...
                  <button
                    onClick={handleLogout}
                    className="flex items-center w-full px-3 py-2 rounded-lg text-sm font-inter bg-neutral-100 text-neutral-700 hover:bg-neutral-200"
                  >
                    <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
                    </svg>
                ...
                <>
                  <Link
                    to="/signin"
                    className="flex items-center px-3 py-2 rounded-lg text-sm font-inter bg-neutral-100 text-neutral-700 hover:bg-neutral-200"
                  >
                    <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h7a3 3 0 013 3v1" />
                    </svg>
                  ...
                  <Link
                    to="/signup"
                    className="flex items-center px-3 py-2 rounded-lg text-sm font-inter bg-primary text-white hover:bg-primary/90"
                  >
                    <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />
                    </svg>
