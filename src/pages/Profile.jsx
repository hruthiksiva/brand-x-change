...
export default function Profile() {
  ...
  const handleUpdateProfile = async (e) => {
    e.preventDefault();
    try {
      await updateUserProfile({ displayName, mobileNumber });
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="bg-white shadow rounded-lg p-6 mb-8">
        <div className="space-y-6">
          ...
          <div>
            <h2 className="text-lg font-semibold text-gray-700 mb-2">Mobile Number</h2>
            {isEditingMobile ? (
              <form onSubmit={handleUpdateProfile} className="flex items-center gap-2">
                <input
                  type="tel"
              ...
              <div className="flex items-center gap-2">
                <p className="text-gray-600">{currentUser.mobileNumber || 'Not provided'}</p>
                <button
